...
echo
echo "Backup complete, please transfer the tarball to the backup server! Use this command: \nscp $archive team7@192.168.7.69:/opt/backups/"
...
echo "Try to run backups at least once every hour incase something breaks"
